    ...
    "produce FlightReceivedList elements in the appropriate topic" in ResourceLoaner.withFixture {
      case Resource(embeddedKafkaConfig, appConfig, kafkaStreamsOptions, topologies) =>
        ...
        val firstMessage = key1 -> FlightReceivedEvent.copy(
          ...
          geography = GeographyInfo(0, 0, 10d, 0)
        )
        ...
        val secondMessage = key2 -> FlightReceivedEvent.copy(
          ...
          icaoNumber = key2,
          updated = now,
          geography = GeographyInfo(40.1d, 9.1d, 200d, 0),
        ...
        val fourthMessage = key4 -> FlightReceivedEvent.copy(
          ...
          icaoNumber = key4,
          updated = now,
          geography = GeographyInfo(40.1d, 9.1d, 10d, 0),
        ...
        val keyZeroAltitude = "zero-altitude"
        val flightWithZeroAltitude = keyZeroAltitude -> FlightReceivedEvent.copy(
          iataNumber = keyZeroAltitude,
        ...
        parkedFlights.head.elements should contain theSameElementsAs List(secondMessage, fourthMessage, flightWithZeroAltitude)
          .map(_._2)
